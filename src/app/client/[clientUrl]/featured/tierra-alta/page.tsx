...
export default function TierraAlta() {
    ...
    return (
        <div className={styles.body1}>
            ...
            <Image src='https://res.cloudinary.com/dnh0z6fm7/image/upload/v1738812484/TIERRA-1536x818_yjqvnd.webp' width={500} height={500} className={styles.heroImage} alt='' sizes="(max-width: 1540px) 100vw, 1540px" />
